...
class FaitObjetDeTransfert
{
    protected $table = 'faitobjetdetransfert';
    protected $primaryKey = 'idTransfert';
    ...
    {
        // Transferts avec libellés joueur et club
        $sql = "SELECT t.*, j.nom AS joueurNom, j.prenom AS joueurPrenom, c.nom AS clubNom
                FROM {$this->table} t
                LEFT JOIN joueur j ON j.idJoueur = t.idJoueur
    ...
    {
        // Transferts filtrés par club destination
        $sql = "SELECT t.*, j.nom AS joueurNom, j.prenom AS joueurPrenom, c.nom AS clubNom
                FROM {$this->table} t
                LEFT JOIN joueur j ON j.idJoueur = t.idJoueur
                LEFT JOIN club c ON c.idClub = t.idClub
